/*  34. Pizzas: Think of at least three kinds of your favorite pizza. Store these pizza names in a array, and then use a for loop 
...
let favorite_pizzas: string[] = ["Pepperoni Cheese", "BBQ Chicken", "Supreme"];
