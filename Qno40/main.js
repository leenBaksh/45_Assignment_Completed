/* 40. Album: Write a function called make_album() that builds a Object describing a music album. The function should take in an artist
 ...
 Add an optional parameter to make_album() that allows you to store the number of tracks on an album. If the calling line includes a value
  for the number of tracks, add that value to the album’s Object. Make at least one new function call that includes the number of tracks on
  an album. */
...
var album1 = make_album("Azan Sami", "Ibadat");
var album2 = make_album("Dylan Wang", "Baby I Love You:", 12);
var album3 = make_album("Cha Eun Woo", "Love Is Gone");
console.log(album1);
console.log(album2);
console.log(album3);
